...
const Hero = () => {
  return (
    <section className='w-full max-container padding-t flex items-center min-h-screen gap-10 justify-center'>
        {/* left */}
        <div className='flex-1'>
            <div className='mb-5'>
                <h1 className='text-6xl leading-[80px] max-w-[10em] font-bold text-primary font-merienda'>Order food online from your favourite local restaurants.</h1>
            </div>
            <div className='my-4'>
                <p className='font-bold font-poppins text-xl text-paragraph'>Freshly made food delivered to your door.</p>
            </div>
            <div className='relative flex mt-5 items-center border border-paragraph rounded-full gap-2'>
                <span className='p-3.5 rounded-full bg-orange-secondary'>
                ...
                <span className='flex-1'>
                    <input type="text" className='p-2 outline-none bg-transparent placeholder:text-paragraph placeholder:text-md font-poppins w-full' placeholder="Enter Your location" name="" id="" />
                </span>
                <span className='bg-primary p-5 flex justify-center w-[200px] text-sm rounded-full text-white cursor-pointer'>
        ...
        <div className='flex-1 flex justify-end relative'>
            ...
            <div  className='absolute -top-32 right-20 border border-white glass-morphism'>
                ...
                <span className='text-2xl font-bold font-poppins text-paragraph'>People Delivered</span>
            </div>
        </div>
    </section>
  )
